...
/// <summary>
/// Dynamic sections for the Refund Policy page
/// </summary>
public class RefundPolicySection
{
    public int Id { get; set; }

    public int RefundPolicyPageId { get; set; }
    ...
    // Navigation property
    public RefundPolicyPage RefundPolicyPage { get; set; } = null!;
}
