...
/// <summary>
/// Dynamic sections for the Delivery Policy page
/// </summary>
public class DeliveryPolicySection
{
    public int Id { get; set; }

    public int DeliveryPolicyPageId { get; set; }
    ...
    // Navigation property
    public DeliveryPolicyPage DeliveryPolicyPage { get; set; } = null!;
}
