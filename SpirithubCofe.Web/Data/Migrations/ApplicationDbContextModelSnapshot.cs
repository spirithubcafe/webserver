...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpirithubCofe.Domain.Entities.ShippingMethod", b =>
                {
                    ...
                    b.Property<string>("AramexAccountCountryCode")
                        .HasMaxLength(5)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexAccountEntity")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexAccountNumber")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexAccountPin")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexApiUrl")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexPassword")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexUsername")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.Property<string>("AramexVersion")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("NoolAccountNumber")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");

                    b.Property<string>("NoolApiKey")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SpirithubCofe.Domain.Entities.ShippingRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ShippingZoneId", "CityId")
                        .IsUnique();

                    b.ToTable("ShippingRates");
                });

            modelBuilder.Entity("SpirithubCofe.Domain.Entities.ShippingZone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ShippingMethodId", "CountryId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpirithubCofe.Domain.Entities.ShippingRate", b =>
                {
                    ...
                    b.HasOne("SpirithubCofe.Domain.Entities.ShippingZone", "ShippingZone")
                        .WithMany("ShippingRates")
            ...
            modelBuilder.Entity("SpirithubCofe.Domain.Entities.ShippingAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SpirithubCofe.Domain.Entities.Order", b =>
                {
                    b.HasOne("SpirithubCofe.Domain.Entities.ShippingAddress", "ShippingAddress")
                        .WithMany("Orders")
