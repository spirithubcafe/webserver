...
using SpirithubCafe.Application.DTOs.API;
using System.IdentityModel.Tokens.Jwt;
using System.Security.Claims;
using System.Text;

namespace SpirithubCafe.Application.Services.API;
...
public class AuthApiService<TUser> : IAuthApiService where TUser : IdentityUser
{
    ...
    private async Task<string> GenerateJwtTokenAsync(TUser user)
    {
        ...
        var tokenDescriptor = new SecurityTokenDescriptor
        {
            ...
            Issuer = jwtSettings["Issuer"] ?? "SpirithubCafe",
            Audience = jwtSettings["Audience"] ?? "SpirithubCafe"
        };
