...
namespace SpirithubCafe.Web.Migrations
{
    ...
    [Migration("20251007074555_AddContactMessagesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.DeliveryPolicyPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DeliveryPolicyPages");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.DeliveryPolicySection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("DeliveryPolicyPageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("DeliveryPolicyPageId");

                    b.ToTable("DeliveryPolicySections");
                });
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("GiftRecipientAddressLine1")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");

                    b.Property<string>("GiftRecipientAddressLine2")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");

                    b.Property<int?>("GiftRecipientCityId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("GiftRecipientCountryId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("GiftRecipientPostalCode")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.PrivacyPolicyPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PrivacyPolicyPages");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.PrivacyPolicySection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("PrivacyPolicyPageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PrivacyPolicyPageId");
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.RefundPolicyPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("RefundPolicyPages");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.RefundPolicySection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("RefundPolicyPageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RefundPolicyPageId");

                    b.ToTable("RefundPolicySections");
                });
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.TermsConditionsPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("TermsConditionsPages");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.TermsConditionsSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("TermsConditionsPageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TermsConditionsPageId");

                    b.ToTable("TermsConditionsSections");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.Translation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.DeliveryPolicySection", b =>
                {
                    b.HasOne("SpirithubCafe.Domain.Entities.DeliveryPolicyPage", "DeliveryPolicyPage")
                        .WithMany("Sections")
                        .HasForeignKey("DeliveryPolicyPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeliveryPolicyPage");
                });
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.PrivacyPolicySection", b =>
                {
                    b.HasOne("SpirithubCafe.Domain.Entities.PrivacyPolicyPage", "PrivacyPolicyPage")
                        .WithMany("Sections")
                        .HasForeignKey("PrivacyPolicyPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrivacyPolicyPage");
                });
            ...
            modelBuilder.Entity("SpirithubCafe.Domain.Entities.RefundPolicySection", b =>
                {
                    b.HasOne("SpirithubCafe.Domain.Entities.RefundPolicyPage", "RefundPolicyPage")
                        .WithMany("Sections")
                        .HasForeignKey("RefundPolicyPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RefundPolicyPage");
                });

            modelBuilder.Entity("SpirithubCafe.Domain.Entities.TermsConditionsSection", b =>
                {
                    b.HasOne("SpirithubCafe.Domain.Entities.TermsConditionsPage", "TermsConditionsPage")
                        .WithMany("Sections")
                        .HasForeignKey("TermsConditionsPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TermsConditionsPage");
                });
